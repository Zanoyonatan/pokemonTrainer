...
namespace pokemonTrainer.Migrations
{
    ...
    [Migration("20260628094916_AddPokemonSearchIndexes")]
    partial class AddPokemonSearchIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pokemonTrainer.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("pokemonTrainer.Models.DreamTeamPokemon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DreamTeamPokemons");
                });

            modelBuilder.Entity("pokemonTrainer.Models.Pokemon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SpecialAttack");

                    b.HasIndex("SpecialDefense");
            ...
            modelBuilder.Entity("pokemonTrainer.Models.PokemonType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("pokemonTrainer.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("pokemonTrainer.Models.DreamTeamPokemon", b =>
                {
                    b.HasOne("pokemonTrainer.Models.Pokemon", "Pokemon")
                        .WithMany()
                        .HasForeignKey("PokemonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("pokemonTrainer.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("pokemonTrainer.Models.PokemonPokemonType", b =>
                {
                    ...
                    b.HasOne("pokemonTrainer.Models.PokemonType", "PokemonType")
                        .WithMany("PokemonTypes")
